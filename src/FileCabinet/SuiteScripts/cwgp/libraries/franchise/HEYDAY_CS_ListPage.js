...
define([], () => {
    ...
    const toCreateTransaction = (stUserId, stAccessType) => {
        ...
        window.location = `https://5530036-sb1.extforms.netsuite.com/app/site/hosting/scriptlet.nl?script=690&deploy=1&compid=5530036_SB1&h=57cb2060b899d3e1ff54&pageMode=create&userId=${stUserId}&accesstype=${stAccessType}&rectype=franchisepo`;
    };
